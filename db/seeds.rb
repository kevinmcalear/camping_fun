...
signup1 = Signup.create(camper: camper1, activity: activity2, time: 11)
signup2 = Signup.create(camper: camper1, activity: activity1, time: 12)
signup3 = Signup.create(camper: camper1, activity: activity4, time: 15)
signup4 = Signup.create(camper: camper2, activity: activity2, time: 11)
signup5 = Signup.create(camper: camper2, activity: activity1, time: 12)
signup6 = Signup.create(camper: camper3, activity: activity4, time: 16)
signup7 = Signup.create(camper: camper3, activity: activity4, time: 16)
signup8 = Signup.create(camper: camper3, activity: activity4, time: 16)
